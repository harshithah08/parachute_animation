...
void clouds()
{
	...
	glvertex2f(20,30,460,460);
	
	glvertex2f(15,20,445,460);
		
	glvertex2f(15,20,475,460);
		
	// 2nd cloud 
	glvertex2f(20,30,390,420);
			
    glvertex2f(15,20,405,420);
			
	glvertex2f(15,20,375,420);
...
int main(int argc, char** argv) {
   ...
   //	glutAddMenuEntry("Stop", 12);
   	glutAddMenuEntry("Vertical & Horizontal Move", 12);
	glutAddMenuEntry("Horizontal Move", 13);
	glutAddMenuEntry("Vertical Move", 14);
